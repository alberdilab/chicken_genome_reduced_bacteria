...
```{r mean_mci_by_mag, warning = FALSE, comments = "", message = FALSE}
# calculate mean MCI by MAG
...
```{r ploting_com_1, warning = FALSE, comments = "", message = FALSE, fig.height = 4, fig.width = 9, fig.fullwidth = TRUE}
