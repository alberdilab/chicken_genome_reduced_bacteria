...
save(distq_1, file = "data/distq_1.Rdata")
...
save(distq_2, file = "data/distq_2.Rdata")
...
save(distq_3, file = "results/tables/distq_3.Rdata")
...
load("data/distq_1.Rdata")
load("data/distq_2.Rdata")
load("data/distq_3.Rdata")
load("data/distq_4.Rdata")
load("data/distq_5.Rdata")
load("data/distq_6.Rdata")
load("data/distq_7.Rdata")
load("data/distq_8.Rdata")

expr_counts_raw <- c(distq_1, distq_2, distq_3, distq_4, distq_5, distq_6, distq_7, distq_8)
