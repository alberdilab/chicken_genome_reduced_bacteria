...
```{r plot_heatmap, comment = "", message = FALSE, warning = FALSE, fig.height = 8, fig.width = 12, fig.fullwidth = TRUE}
mag_subset_elements_2 %>%
  rename(Code_function = "Function") %>% 
  left_join(gift_colors, by = "Code_function") %>%
...
```{r pcoa, warning = FALSE, comments = "", message = FALSE, fig.height = 9, fig.width = 9, fig.fullwidth = TRUE}
ggplot() +
...
```{r plot_heatmap_reduced, comment = "", message = FALSE, fig.width = 9, fig.height = 9, warning = FALSE}
mag_subset_elements_3 %>%
  rename(Code_element = "Element") %>% 
  rename(Code_function = "Function") %>% 
